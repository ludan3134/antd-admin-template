...
import {getRoleIdByLiveCat4Id} from "@/pages/Account/config/api/getRoleIdByLiveCat4Id";

const AssignForm: React.FC<API.UpdateFormProps> = ({actionRef, liveCat4Id}) => {
  const intl = useIntl();
  ...
  return (
    <>
      <ModalForm
        ...
        request={async () => {
          let res = await getRoleIdByLiveCat4Id([liveCat4Id])
