...
import {getRoleIdByLiveCat3Id} from "@/pages/Account/config/api/getRoleIdByLiveCat3Id";

const AssignForm: React.FC<API.UpdateFormProps> = ({actionRef, liveCat3Id}) => {
  const intl = useIntl();
  ...
  return (
    <>
      <ModalForm
        ...
        request={async () => {
          let res = await getRoleIdByLiveCat3Id([liveCat3Id])
